...
from ultralytics.yolo.utils.tal import TORCH_1_10
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        coords = torch.stack(torch.meshgrid([coords_h, coords_w],indexing='ij'))  if TORCH_1_10 else \
            torch.stack(torch.meshgrid([coords_h, coords_w])) # 2, Wh, Ww
